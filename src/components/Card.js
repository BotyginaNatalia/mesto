export default class Card {
  ...
  generateCard() {
    ...
    this._setLikeFromMe = this._likes.some((like) => like._id === this._userId);
  ...
  _setEventListeners() {
    this._likeButton.addEventListener("click", () =>
      this._handleLikeClick(this, this._setLikeFromMe)
    );
  ...
  addNewLike() {
    this._likeButton.classList.add("element__like-button_active");
    this._numberOfLikes.textContent = this._likes.length + 1;
  }
